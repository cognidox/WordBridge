...
<div class="wordbridge_blog blog<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
    ...
    <div class="wordbridge_entries">
		...
		<span class="wordbridge_date"><?php /*echo WordbridgeHelper::wordBridgeStrftime( '%B %e, %Y', $entry['date'], true ); */ echo WordbridgeHelper::wordBridgeStrftime( 'F j, Y', $entry['date'], true ); ?></span>
